...
const Home = function (model) {
  ...
  async function getHome(homesList, id) {
    const homes = await model.findByIds(homesList).catch((err) => {
  ...
  model.homes = async function (session) {
    ...
    // get latest status for all homes
    const promises = [];
  ...
  model.toggleCameras = async function (session, id, body) {
    ...
    const result = await devices.armCameras(home, arm).catch((err) => {
  ...
  model.toggleLocks = async function (session, id, body) {
    ...
    const result = await devices.lockHome(home, locked).catch((err) => {
  ...
  model.toggleWater = async function (session, id, body) {
    ...
    const result = await devices.shutOffWater(home, closed).catch((err) => {
  ...
  model.toggleEcoTheromostats = async function (session, id, body) {
    ...
    const result = await devices.ecoThermostats(home, eco).catch((err) => {
